        ...
        tvGetYanzhengma.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!ph_emNum.equals("")) {
                    ...
                    //判断ph_emNum 是什么类型，正则表达,，邮箱正则\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*    手机正则\d{3}-\d{8}|\d{4}-\d{7}或者(\d{3}-|\d{4}-)?(\d{8}|\d{7})?
                    isMobile = isMobilNO(ph_emNum);
                    isEmail = isEmailNO(ph_emNum);
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!TextUtils.isEmpty(yanzhengma)){
                    ...
                    } else if(action_type.equals(EMAIL)){
